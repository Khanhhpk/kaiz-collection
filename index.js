...
// ==========================================
const KAIZ_CURRENT_VERSION = '2.0.5.1';
    ...
    modal.innerHTML = `
        <div style="display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid rgba(255,255,255,0.08); padding-bottom: 14px;">
            <div style="display: flex; align-items: center; gap: 14px;">
                ...
                <div>
                    <div style="font-weight: 800; font-size: 1.15em; color: #10b981; letter-spacing: 0.3px;">KAIZ COLLECTION v2.0.5.1</div>
        ...
        <div style="font-size: 0.95em; color: #cbd5e1; line-height: 1.6;">
            ...
            Bản cập nhật <b>2.0.5.1</b> tập trung vào việc vá lỗi và tối ưu hóa các tính năng cốt lõi.<br><br>
...
waitForEnvironment(async (targetWin, jq) => {
    ...
    // Tự động hiển thị bảng cập nhật nếu là version mới (hiện tại hiển thị cho 2.0.5.1)
    if (config.last_seen_patch_notes_version !== KAIZ_CURRENT_VERSION) {
        if (KAIZ_CURRENT_VERSION === '2.0.5.1') {
            setTimeout(() => {
                showKaizPatchNotes(targetWin);
            }, 3000);
        }
