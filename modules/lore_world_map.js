...
{{existing_map}}
======================
NẾU một địa điểm đã tồn tại trong danh sách trên, bạn PHẢI BỔ SUNG trường "id" của nó vào JSON. ĐỒNG THỜI, CHỈ CẦN XUẤT CÁC TRƯỜNG CẦN CẬP NHẬT. Các trường động (như 'atmosphere', 'characters', 'description'...) CÓ THỂ xuất lại để cập nhật nếu bối cảnh/thời gian thay đổi (ví dụ: chuyển từ ngày sang đêm, hoặc xuất 'characters': [] nếu họ rời đi). Các trường tĩnh (như 'grid_hint', 'name', 'icon'...) NẾU ĐÃ CHUẨN RỒI THÌ HÃY BỎ QUA KHỎI JSON để giữ nguyên gốc, CHỈ XUẤT NẾU thực sự thấy sai logic hoặc bị outdate! Nếu là địa điểm mới hoàn toàn, HÃY BỎ TRỐNG trường "id" và PHẢI ĐIỀN ĐẦY ĐỦ tất cả các trường.
...
{{existing_map}}
==========================
NẾU một phân khu ĐÃ TỒN TẠI, bạn PHẦI ĐIỀN trường "id" để CẬP NHẬT nó. ĐỒNG THỜI, CHỈ CẦN XUẤT CÁC TRƯỜNG CẦN CẬP NHẬT. Các trường động (như 'atmosphere', 'characters', 'description'...) CÓ THỂ xuất lại để cập nhật nếu bối cảnh/thời gian thay đổi (ví dụ: chuyển từ ngày sang đêm, hoặc xuất 'characters': [] nếu họ rời đi). Các trường tĩnh (như 'grid_hint', 'name', 'icon'...) NẾU ĐÃ CHUẨN RỒI THÌ HÃY BỎ QUA KHỎI JSON để giữ nguyên gốc, CHỈ XUẤT NẾU thực sự thấy sai logic hoặc bị outdate! NẾU LÀ PHÂN KHU TẠO MỚI: Bỏ trống trường "id" và PHẢI ĐIỀN ĐẦY ĐỦ tất cả các trường.
