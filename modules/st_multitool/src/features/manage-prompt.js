...
import { captureOriginalSnapshot, restoreOriginalSnapshot, getPromptContainer, getCurrentEditorSnapshot, savePromptBlocks } from './preset-io.js';

export { getCurrentEditorSnapshot, savePromptBlocks, getPromptContainer, captureOriginalSnapshot, restoreOriginalSnapshot };
...
export function clearPendingBlockChanges() {
  _pendingAdds = [];
  _pendingDeletes.clear();
}
export function getPendingAdds() { return _pendingAdds; }
export function getPendingDeletes() { return _pendingDeletes; }
